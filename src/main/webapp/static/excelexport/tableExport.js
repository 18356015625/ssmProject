...
(function ($) {
  ...
  $.fn.tableExport = function (options) {
    ...
    var defaults = {
      ...
      jspdf: {                          // jsPDF / jsPDF-AutoTable related
										// options
        ...
        format:            'a4',        // One of jsPDF page formats or
										// 'bestfit' for autmatic paper format
										// selection
        ...
        autotable: {
          ...
          styles: {
            ...
            fillColor:     255,         // Color value or 'inherit' to use css
										// background-color from html table

            textColor:     50,          // Color value or 'inherit' to use css
										// color from html table

            fontStyle:     'normal',    // normal, bold, italic, bolditalic or
										// 'inherit' to use css font-weight and
										// fonst-style from html table

            overflow:      'ellipsize', // visible, hidden, ellipsize or
										// linebreak

            halign:        'inherit',   // left, center, right or 'inherit' to
										// use css horizontal cell alignment
										// from html table
          ...
          headerStyles: {
            ...
            halign:        'inherit',   // left, center, right or 'inherit' to
										// use css horizontal header cell
										// alignment from html table
          ...
          tableExport: {
            ...
            doc:               null,    // jsPDF doc object. If set, an already
										// created doc will be used to export to
      ...
      mso: {                            // MS Excel and MS Word related options
        ...
        fileFormat:        'xlshtml',   // xlshtml = Excel 2000 html format
                                        ...
                                        // xmlss = XML Spreadsheet 2003 file
										// format (XMLSS)
        ...
        onMsoNumberFormat: null,        // Excel 2000 html format only. See
										// readme.md for more information about
										// msonumberformat

        pageFormat:        'a4',        // Page format used for page orientation

        pageOrientation:   'portrait',  // portrait, landscape (xlshtml format
										// only)

        rtl:               false,       // true = Set worksheet option
										// 'DisplayRightToLeft'

        styles:            [],          // E.g. ['border-bottom', 'border-top',
      ...
      numbers: {
        ...
        output: {                       // Use 'output: false' to keep number
      ...
      onBeforeSaveToFile:  null,        // Return false as result to abort save
										// process
      ...
      onIgnoreRow:         null,        // onIgnoreRow($tr, rowIndex): function
										// should return true to not export a
										// row
      ...
      pdfmake: {
        ...
        enabled:           false,       // true: use pdfmake instead of jspdf
										// and jspdf-autotable (experimental)
        ...
        docDefinition: {
          ...
          defaultStyle: {
            ...
            font:          'Roboto'     // Default is 'Roboto', for arabic font
										// set this option to 'Mirza' and
										// include mirza_fonts.js
      ...
      preventInjection:    true,        // Prepend a single quote to cell
										// strings that start with =,+,- or @ to
										// prevent formula injection

      sql: {

        tableEnclosure:     '`',        // If table or column names contain any
										// characters except letters, numbers,
										// and

        columnEnclosure:    '`'         // underscores usually the name must be
										// delimited by enclosing it in back
										// quotes (`)
      ...
      tfootSelector:       'tr',        // Set empty ('') to prevent export of
										// tfoot rows
      ...
      type:                'csv'        // 'csv', 'tsv', 'txt', 'sql', 'json',
										// 'xml', 'excel', 'doc', 'png' or 'pdf'

    };



    var pageFormats = { // Size in pt of various paper formats. Adopted from
						// jsPDF.
      ...
      var csvString = function (cell, rowIndex, colIndex) {
        ...
        if ( cell !== null ) {
          ...
          if ( defaults.type === 'tsv' ) {
            ...
            // Takes a string and encapsulates it (by default in double-quotes)
			// if it
      ...
      if ( defaults.pdfmake.enabled === true ) {
        ...
        loadImages(teOptions, function () {
          ...
          $(el).filter(function () {
            ...
            // onTable: optional callback function for every matching table that
			// can be used
            ...
            if ( typeof atOptions.createdHeaderCell !== 'function' ) {
              ...
              atOptions.createdHeaderCell = function (cell, data) {
                ...
                // jsPDF AutoTable plugin v2.0.14 fix: each cell needs its own
				// styles object
              ...
              ForEachVisibleCell(this, 'td,th', rowIndex, $hrows.length + $rows.length,
                                 ...
                                 function (cell, row, col) {
                                   ...
                                   if ( typeof teOptions.columns[colKey] === 'undefined' ) {
                                     ...
                                     // jsPDF-Autotable needs columns. Thus
										// define hidden ones for tables without
										// thead
      ...
      if ( cell !== null ) {
        ...
        if ( defaults.htmlContent === true ) {
          ...
          if ( cellFormat !== '' ) {
            ...
            result = result.replace(/\u00A0/g, " "); // replace nbsp's with
														// spaces
